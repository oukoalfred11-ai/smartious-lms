 ...
 * Question Bank API + seed data
 * Mounted at /api/questions
 * GET    /api/questions              — list/search questions
 * POST   /api/questions              — create question
 * PATCH  /api/questions/:id          — update question
 * DELETE /api/questions/:id          — delete question
 * POST   /api/questions/seed         — seed built-in questions (admin)
 * GET    /api/questions/topics       — list topics per subject/curriculum
 */
...
// Mathematics, Physics, Chemistry, Biology, Business, CS
// Supports: CambridgeIGCSE, EdexcelIGCSE, CambridgeALevel, KenyaCBC, IB
// Math notation: use ^ for powers, sqrt() for roots, fractions as a/b
// ════════════════════════════════════════════════════
...
{ subject:'Biology', topic:'Cell Biology', curriculum:'EdexcelIGCSE', grade:'Year 10', difficulty:'easy',
...
{ subject:'Biology', topic:'Cell Biology', curriculum:'CambridgeIGCSE', grade:'Year 10', difficulty:'medium',
...
{ subject:'Biology', topic:'Photosynthesis', curriculum:'EdexcelIGCSE', grade:'Year 10', difficulty:'easy',
...
{ subject:'Biology', topic:'Photosynthesis', curriculum:'CambridgeIGCSE', grade:'Year 10', difficulty:'medium',
...
{ subject:'Biology', topic:'Respiration', curriculum:'EdexcelIGCSE', grade:'Year 10', difficulty:'medium',
...
{ subject:'Biology', topic:'Genetics', curriculum:'CambridgeIGCSE', grade:'Year 11', difficulty:'hard',
...
{ subject:'Biology', topic:'Genetics', curriculum:'EdexcelIGCSE', grade:'Year 11', difficulty:'medium',
...
{ subject:'Biology', topic:'Human Biology', curriculum:'EdexcelIGCSE', grade:'Year 10', difficulty:'easy',
...
{ subject:'Biology', topic:'Ecology', curriculum:'CambridgeIGCSE', grade:'Year 10', difficulty:'medium',
