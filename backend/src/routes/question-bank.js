    ...
    for (let i = 0; i < items.length; i++) {
      ...
      try {
        ...
        if (type === 'mcq') {
          ...
          // AI marking has been removed from the platform. Teachers
          // mark typed, drawn and essay answers themselves, so a mark
          // scheme is optional context, never a requirement, and its
          // absence no longer blocks or flags anything.
        }
