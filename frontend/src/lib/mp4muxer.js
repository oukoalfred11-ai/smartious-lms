/*!
 * mp4-muxer v5.2.2 (vendored) — https://github.com/Vanilagy/mp4-muxer
 * MIT License. Copyright (c) Vanilagy.
 * Vendored into the Smartious LMS so the Studio's fast MP4 export
 * needs no package installation — the file builds anywhere.
 */
