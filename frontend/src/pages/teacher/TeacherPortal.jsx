...
export default function ParentPortal() {
  ...
  return (
    <div className="app">
      <style>{`
        .app{background:#FBFAF5!important}
        .sidebar{background:#FBFAF5!important;border-right:1px solid #F4EFEB!important;}
        .sb-logo{border-bottom:1px solid #F4EFEB!important;padding:20px 22px!important;}
        .sb-mark{background:transparent!important;box-shadow:none!important;width:36px!important;height:40px!important;padding:0!important;}
        .sb-text{color:#1A0F0E!important;font-family:'Instrument Serif',Georgia,serif!important;font-size:21px!important;}
        .sb-text span{color:#7D1025!important;font-style:italic!important;}
        .sb-sub{color:#7D1025!important;font-weight:700!important;letter-spacing:.14em!important;}
        .sb-sec{color:#7D1025!important;font-weight:700!important;font-size:10px!important;}
        ...
        .sb-user{border-top:1px solid #F4EFEB!important;}
        ...
        .topbar{background:rgba(251,250,245,.9)!important;backdrop-filter:saturate(180%) blur(20px)!important;-webkit-backdrop-filter:saturate(180%) blur(20px)!important;border-bottom:1px solid #F4EFEB!important;}
        .tb-title{color:#1A0F0E!important;font-family:'Instrument Serif',Georgia,serif!important;font-size:22px!important;}
        .tb-chip,.btn.btn-s{background:#FBFAF5!important;border-color:#E8E2D6!important;color:#564844!important;}
        .content{background:#FBFAF5!important;}
      ...
      <aside className="sidebar">
        <div className="sb-logo">
          <div className="sb-mark" style={{background:'transparent',boxShadow:'none',width:36,height:40,padding:0}}>
          ...
          <div><div className="sb-text">Smart<span>ious</span></div><div className="sb-sub">Parent Portal</div></div>
        </div>
