...
// ═══════════════════════════════════════════════════════════
// LIVE LESSONS — Teacher Module
// ═══════════════════════════════════════════════════════════
//
// Replaces the existing `{page === 'classroom'}` block which currently
// goes STRAIGHT into the whiteboard. The new flow is:
//
//   Teacher clicks Classroom in sidebar
//      → sees the LESSONS HUB (this module: schedule, roster, history)
//      → clicks "Start Class" or "Join Live"
//      → ENTERS the LiveClassroom whiteboard
//      → leaves whiteboard → back to hub
//
// HOW TO APPLY — TWO STEPS
//
// STEP 1: Replace the existing classroom block in TeacherPortal.jsx
//
//   Press Ctrl+F and search for: page === 'classroom' && (
//   You'll find it at line ~559:
//
//     {page === 'classroom' && (
//       <LiveClassroom
//         role="teacher"
...
//     )}
//
//   Select that entire block (about 6 lines).
//   Replace with this single line:
//
//          {page === 'classroom' && <TeacherLiveLessonsTab user={user} store={store} setPage={setPage} toast={toast} />}
//
// STEP 2: Add component at bottom of TeacherPortal.jsx (column 1)
//
//   Press Ctrl+End. Click after the final `}`. Press Enter twice.
