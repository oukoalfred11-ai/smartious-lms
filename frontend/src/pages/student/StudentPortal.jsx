...
const QUESTION_BANK = {
  Mathematics: {
    'Algebra': [
      ...
      { q: 'Expand (x + 4)(x - 2)', options: ['x^2 + 2x - 8', 'x^2 - 2x - 8', 'x^2 + 6x - 8', 'x^2 + 2x + 8'], answer: 'x^2 + 2x - 8', explanation: 'FOIL: x*x + x*(-2) + 4*x + 4*(-2) = x^2 - 2x + 4x - 8 = x^2 + 2x - 8.' },
      { q: 'Factorise:  x^2 - 9', options: ['(x - 3)(x - 3)', '(x + 3)(x - 3)', '(x + 9)(x - 1)', 'Cannot be factorised'], answer: '(x + 3)(x - 3)', explanation: 'Difference of two squares: a^2 - b^2 = (a + b)(a - b). Here a = x, b = 3.' },
    ...
    'Geometry & Pythagoras': [
      { q: 'A right-angled triangle has legs 6 cm and 8 cm. What is the hypotenuse?', options: ['10 cm', '14 cm', '12 cm', '7 cm'], answer: '10 cm', explanation: 'Pythagoras: c^2 = 6^2 + 8^2 = 36 + 64 = 100, so c = 10 cm.' },
      { q: 'Which set is a Pythagorean triple?', options: ['(2, 3, 4)', '(5, 12, 13)', '(4, 5, 6)', '(1, 2, 3)'], answer: '(5, 12, 13)', explanation: '5^2 + 12^2 = 25 + 144 = 169 = 13^2. The others do not satisfy a^2 + b^2 = c^2.' },
      { q: 'The area of a triangle with base 10 cm and height 6 cm is:', options: ['60 sq cm', '30 sq cm', '16 sq cm', '32 sq cm'], answer: '30 sq cm', explanation: 'Area = 0.5 * base * height = 0.5 * 10 * 6 = 30 square cm.' },
      { q: 'The interior angles of a triangle sum to:', options: ['90 degrees', '180 degrees', '270 degrees', '360 degrees'], answer: '180 degrees', explanation: 'Standard geometry fact: interior angles of any triangle always sum to 180 degrees.' },
      { q: 'A square has perimeter 24 cm. What is its area?', options: ['36 sq cm', '48 sq cm', '72 sq cm', '144 sq cm'], answer: '36 sq cm', explanation: 'Side length = 24 / 4 = 6 cm. Area = 6^2 = 36 square cm.' },
    ],
    'Number & Percentages': [
      ...
      { q: 'What is the value of 2^3 * 3^2?', options: ['72', '36', '54', '108'], answer: '72', explanation: '2^3 = 8 and 3^2 = 9. So 8 * 9 = 72.' },
    ...
    'Trigonometry': [
      { q: 'In a right triangle, sin(theta) is defined as:', options: ['Opposite / Hypotenuse', 'Adjacent / Hypotenuse', 'Opposite / Adjacent', 'Hypotenuse / Opposite'], answer: 'Opposite / Hypotenuse', explanation: 'SOH from SOH-CAH-TOA: sin = Opposite / Hypotenuse.' },
      { q: 'What is sin(30 degrees)?', options: ['0.5', '0.707', '0.866', '1'], answer: '0.5', explanation: 'sin(30) = 1/2 = 0.5. This is a standard angle to memorise.' },
      { q: 'cos(60 degrees) equals:', options: ['sqrt(3)/2', '1/2', 'sqrt(2)/2', '1'], answer: '1/2', explanation: 'cos(60) = 0.5. Note: cos(60) = sin(30).' },
      { q: 'Which of these statements is true?', options: ['sin^2(t) + cos^2(t) = 1', 'sin^2(t) - cos^2(t) = 1', 'sin(t) + cos(t) = 1', 'tan(t) = sin(t) * cos(t)'], answer: 'sin^2(t) + cos^2(t) = 1', explanation: 'Pythagorean identity. Always true for any angle t.' },
      { q: 'tan(45 degrees) =', options: ['0', '1', 'sqrt(2)', 'infinity'], answer: '1', explanation: 'tan(45) = sin(45)/cos(45) = 1.' },
    ],
  },
 
  Physics: {
    'Forces & Motion': [
      { q: 'Newton\'s second law is expressed as:', options: ['F = ma', 'F = m/a', 'F = m + a', 'F = m - a'], answer: 'F = ma', explanation: 'Force = mass times acceleration. Standard Newton\'s second law equation.' },
      { q: 'A car accelerates from rest at 4 m/s^2. After 5 seconds its velocity is:', options: ['9 m/s', '20 m/s', '25 m/s', '4 m/s'], answer: '20 m/s', explanation: 'v = u + at = 0 + 4 * 5 = 20 m/s.' },
      { q: 'The SI unit of force is:', options: ['Joule', 'Watt', 'Newton', 'Pascal'], answer: 'Newton', explanation: '1 Newton = 1 kg*m/s^2. Named after Sir Isaac Newton.' },
      { q: 'Acceleration due to gravity on Earth is approximately:', options: ['8.8 m/s^2', '9.8 m/s^2', '10.8 m/s^2', '11.8 m/s^2'], answer: '9.8 m/s^2', explanation: 'g is about 9.8 m/s^2 near Earth\'s surface (often rounded to 10 in IGCSE problems).' },
    ...
    'Electricity': [
      { q: 'Ohm\'s Law states:', options: ['V = IR', 'V = I/R', 'V = I + R', 'V = I - R'], answer: 'V = IR', explanation: 'Voltage = Current times Resistance. Foundation of basic circuit analysis.' },
      { q: 'The SI unit of electrical resistance is:', options: ['Volt', 'Ampere', 'Ohm', 'Watt'], answer: 'Ohm', explanation: '1 Ohm = 1 V/A. Named after Georg Ohm.' },
      { q: 'In a series circuit, the current:', options: ['Is the same everywhere', 'Splits at each junction', 'Increases with each component', 'Decreases with each component'], answer: 'Is the same everywhere', explanation: 'In series, current has only one path so it is identical at every point.' },
      { q: 'A 12 V battery drives 3 A through a circuit. The resistance is:', options: ['4 Ohms', '36 Ohms', '15 Ohms', '0.25 Ohms'], answer: '4 Ohms', explanation: 'R = V/I = 12/3 = 4 Ohms.' },
      { q: 'Power dissipated by a resistor is given by:', options: ['P = VI', 'P = V/I', 'P = V + I', 'P = V - I'], answer: 'P = VI', explanation: 'Power = Voltage * Current. Also expressible as I^2*R or V^2/R.' },
    ],
    'Waves': [
      { q: 'Wave speed equation:', options: ['v = f*lambda', 'v = f/lambda', 'v = f + lambda', 'v = f - lambda'], answer: 'v = f*lambda', explanation: 'Speed = frequency times wavelength. Fundamental wave equation.' },
      ...
      { q: 'Light travels in a vacuum at approximately:', options: ['3 x 10^5 m/s', '3 x 10^6 m/s', '3 x 10^8 m/s', '3 x 10^10 m/s'], answer: '3 x 10^8 m/s', explanation: 'The speed of light in a vacuum is about 299,792,458 m/s = 3 x 10^8 m/s.' },
    ...
    'Energy': [
      ...
      { q: 'Kinetic energy is calculated as:', options: ['0.5*m*v^2', 'm*v^2', 'm*g*h', 'm*v'], answer: '0.5*m*v^2', explanation: 'KE = 0.5 * mass * velocity^2. Note the factor of one-half.' },
      { q: 'Gravitational potential energy is:', options: ['m*g*h', '0.5*m*v^2', 'm*v', 'F * d'], answer: 'm*g*h', explanation: 'GPE = mass * gravity * height. Energy stored due to position above a reference level.' },
  ...
  Biology: {
    ...
    'Ecology': [
      { q: 'Producers in an ecosystem are typically:', options: ['Herbivores', 'Carnivores', 'Plants', 'Decomposers'], answer: 'Plants', explanation: 'Plants produce their own food via photosynthesis. They are the base of most food chains.' },
      ...
      { q: 'Which gas do plants take in for photosynthesis?', options: ['Oxygen', 'Carbon dioxide', 'Nitrogen', 'Hydrogen'], answer: 'Carbon dioxide', explanation: 'Plants absorb CO2 and release O2 during photosynthesis.' },
    ],
  },
  ...
  Chemistry: {
    ...
    'The Periodic Table': [
      ...
      { q: 'As you go down Group 1, reactivity:', options: ['Decreases', 'Increases', 'Stays the same', 'Becomes zero'], answer: 'Increases', explanation: 'Outer electron is held less tightly going down the group, so it is easier to lose, making the element more reactive.' },
    ...
    'Chemical Reactions': [
      ...
      { q: 'Balance:  H2 + O2 -> H2O. Coefficients are:', options: ['1, 1, 1', '2, 1, 2', '1, 2, 2', '2, 2, 1'], answer: '2, 1, 2', explanation: '2H2 + O2 -> 2H2O. Now: 4 H atoms each side, 2 O atoms each side. Balanced.' },
      ...
      { q: 'Which gas turns limewater milky?', options: ['Oxygen', 'Hydrogen', 'Carbon dioxide', 'Nitrogen'], answer: 'Carbon dioxide', explanation: 'CO2 reacts with calcium hydroxide (limewater) forming insoluble calcium carbonate, the white cloudiness.' },
    ],
    'Acids, Bases & Salts': [
      ...
      { q: 'A base produces which ion in water?', options: ['H+', 'OH-', 'O2-', 'H3O+'], answer: 'OH-', explanation: 'Alkalis (soluble bases) release OH- (hydroxide ions) in water.' },
      { q: 'Acid + Base ->', options: ['Salt + Hydrogen', 'Salt + Water', 'Salt + Carbon dioxide', 'No reaction'], answer: 'Salt + Water', explanation: 'Neutralisation: H+ + OH- -> H2O. The remaining ions form a salt.' },
      { q: 'Acid + Metal ->', options: ['Salt + Water', 'Salt + Hydrogen', 'Salt + Oxygen', 'No reaction'], answer: 'Salt + Hydrogen', explanation: 'A reactive metal displaces hydrogen from an acid, producing the metal salt and H2 gas.' },
  ...
  English: {
    ...
    'Grammar & Punctuation': [
      ...
      { q: 'A semicolon is used to:', options: ['End a sentence', 'Join two related independent clauses', 'Introduce a list', 'Show possession'], answer: 'Join two related independent clauses', explanation: 'Example: "I love coffee; she prefers tea." Both halves could stand alone, but they are closely linked.' },
