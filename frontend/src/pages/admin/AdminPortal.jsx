...
export default function AdminPortal() {
  ...
  const navSections = [
    ...
    { label: 'Users', items: [
      ...
      mk('payroll', 'Payroll', '<rect x="2" y="5" width="20" height="14" rx="2"/><line x1="2" y1="10" x2="22" y2="10"/>'),
      mk('leave', 'Leave Requests', '<rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/>'),
      mk('programmes', 'IUFP & Study Abroad', '<path d="M22 10v6M2 10l10-5 10 5-10 5z"/><path d="M6 12v5c3 3 9 3 12 0v-5"/>'),
      mk('livelessons', 'Live Lessons', '<polygon points="23 7 16 12 23 17 23 7"/><rect x="1" y="5" width="15" height="14" rx="2"/>'),
      mk('grouprooms', 'Group Rooms', '<path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/>'),
    ]},
    { label: 'Content', items: [
      mk('curriculum', 'Curriculum', '<path d="M4 19V6a2 2 0 0 1 2-2h13a1 1 0 0 1 1 1v13"/><path d="M4 19a2 2 0 0 0 2 2h14"/><line x1="8" y1="10" x2="16" y2="10"/>'),
    ...
    { label: 'System', items: [
      ...
      mk('settings', 'System Settings', '<circle cx="12" cy="12" r="3"/><path d="M19.07 4.93a10 10 0 0 1 0 14.14M4.93 4.93a10 10 0 0 0 0 14.14"/>'),
      mk('ai', 'Mshauri AI', '<path d="M12 2L2 7l10 5 10-5-10-5z"/><path d="M2 17l10 5 10-5"/><path d="M2 12l10 5 10-5"/>'),
    ]},
  ]
