      ...
      <section className="sec" style={{
        ...
        <div className="wrap" style={{maxWidth:920,margin:'0 auto',position:'relative',zIndex:2}}>
          ...
          <div style={{display:'flex',gap:14,flexWrap:'wrap',alignItems:'center'}}>
            ...
            <a href={`https://wa.me/254745021212?text=${encodeURIComponent(country.whatsappTrigger || ('Hi, I would like to enquire about Smartious for our family in ' + country.name))}`}
              target="_blank" rel="noopener noreferrer"
              style={{background:'#25D366',color:'#fff',border:'none',padding:'18px 32px',borderRadius:10,fontSize:16,fontWeight:800,cursor:'pointer',display:'inline-flex',alignItems:'center',gap:10,textDecoration:'none',letterSpacing:'.01em',boxShadow:'0 8px 24px rgba(37,211,102,.35)',transition:'all .18s ease'}}
      ...
      <section className="sec" style={{background:V.ink,color:'#fff',paddingTop:64,paddingBottom:64,position:'relative',overflow:'hidden'}}>
        ...
        <div className="wrap" style={{maxWidth:820,textAlign:'center',position:'relative',zIndex:1}}>
          ...
          <div style={{display:'flex',justifyContent:'center',marginBottom:18,gap:14,flexWrap:'wrap'}}>
            ...
            <a href={`https://wa.me/254745021212?text=${encodeURIComponent(country.whatsappTrigger || ('Hi, I would like to enquire about Smartious for our family in ' + country.name))}`}
              target="_blank" rel="noopener noreferrer"
              style={{background:'#25D366',color:'#fff',border:'none',padding:'20px 36px',borderRadius:10,fontSize:16,fontWeight:800,cursor:'pointer',display:'inline-flex',alignItems:'center',gap:10,textDecoration:'none',letterSpacing:'.01em',boxShadow:'0 10px 28px rgba(37,211,102,.4)',transition:'all .18s ease'}}
