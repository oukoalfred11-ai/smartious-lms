...
export const MEXICO_CITIES = [
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    faqs: [
      { q: 'Nine hours is a big gap — how does this actually work?', a: 'It works in one direction and we are direct about that: our classes land in the Mexican morning, not the afternoon. A 07:00-10:00 block in Mexico is late afternoon in Nairobi. For a student in turno vespertino whose school runs in the afternoon, that is the free half of the day; for a full-time or post-compulsory student it is the natural teaching slot. An Both after-school and morning blocks are available, since we run two teaching teams in different time zones.' },
...
export const MEXICO_COUNTRY = {
  ...
  faqs: [
    { q: 'You are nine hours ahead — how can this possibly work?', a: 'In one direction, and we lead with that rather than hide it. Our classes land in the Mexican morning: a 07:00-10:00 Mexican block is late afternoon in Nairobi. For students in turno vespertino, whose school runs in the afternoon, that is exactly the free half of the day — and full-time students take mornings anyway. An Both after-school and morning blocks are available, since we run two teaching teams in different time zones. If your child is in turno matutino, talk to us before enrolling so we can be realistic about which subjects and days work.' },
