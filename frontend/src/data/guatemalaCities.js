...
// teaching lands in the GUATEMALAN MORNING only; after-school is
// impossible. A 07:00 Guatemalan class is 16:00 Nairobi. State
...
export const GUATEMALA_CITIES = [
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    whyChoose: [
      ...
      ['Morning classes, the only option at nine hours', 'A seven o\'clock Guatemalan class is four in the afternoon for our teachers. After-school is impossible from our side and we say so.'],
    ...
    faqs: [
      ...
      { q: 'Nine hours — how does this work?', a: 'In one direction. Our classes land in the Guatemalan morning; after-school is impossible from our side. For a student in jornada vespertina, whose school runs in the afternoon, mornings are free and it works cleanly.' },
...
export const GUATEMALA_COUNTRY = {
  ...
  trustSignals: [
    ...
    { h: 'Morning teaching, and why it is the only option', p: 'We are nine hours ahead — tied with Mexico and Costa Rica as our widest gap. Our classes land in the Guatemalan morning and after-school is impossible from our side. Schools commonly run jornada matutina and vespertina, so an afternoon-shift student has mornings free.' },
  ...
  legalFramework: [
    ...
    { h: 'The timezone, and the school day that makes it workable', p: 'We teach from Nairobi at UTC+3 and Guatemala runs CST at UTC-6 with no daylight saving, a fixed nine-hour gap — tied with Mexico and Costa Rica as the widest in our coverage. Our teaching lands in the Guatemalan morning, which means an after-school arrangement is simply not possible from our side. What makes it workable is the Guatemalan school day: schools commonly run jornada matutina and vespertina, so a student on the afternoon shift has mornings entirely free, which is exactly our window. Families whose child is in jornada matutina should talk to us before enrolling so we can be realistic about which subjects and days work.' },
  ],
  ...
  faqs: [
    ...
    { q: 'Is Smartious a MINEDUC-authorised institution?', a: 'No, and we say so plainly. Private schools operate with MINEDUC authorisation. We work alongside a Guatemalan school that holds it, and teach Cambridge, Edexcel, IB and AP qualifications.' },
    { q: 'Nine hours behind — how does the timetable work?', a: 'Our classes land in the Guatemalan morning; after-school is impossible from our side. For students in jornada vespertina that is the free half of the day. Jornada matutina families should talk to us before enrolling so we can be realistic.' },
