...
export const COLOMBIA_CITIES = [
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    faqs: [
      ...
      { q: 'Eight hours — how does the timetable work?', a: 'Our classes land in the Colombian morning, not the afternoon. For a student in jornada tarde, whose school runs in the afternoon, that is exactly the free half of the day. After-school and morning blocks are both available, since we run two teaching teams in different time zones.' },
